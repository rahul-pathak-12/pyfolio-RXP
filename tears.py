...
def create_returns_tear_sheet(returns, live_start_date=None,
    ...
    gs = gridspec.GridSpec(vertical_sections, 3, wspace=1, hspace=1)
...
def create_position_tear_sheet(returns, positions, gross_lev=None,
    ...
    fig.savefig( 'position_tear_sheet.png' )
    plt.show()
    if return_fig:
        return fig
...
def create_txn_tear_sheet(returns, positions, transactions,
    ...
    fig.savefig( 'txn_tear_sheet.png' )
    plt.show()
    if return_fig:
        return fig
...
def create_round_trip_tear_sheet(returns, positions, transactions,
    ...
    fig.savefig( 'round_trip_tear_sheet.png' )
    plt.show()
    if return_fig:
        return fig
...
def create_interesting_times_tear_sheet(
    ...
    fig.savefig( 'interesting_times_tear_sheet.png' )
    plt.show()
    if return_fig:
        return fig
